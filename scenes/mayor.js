class mayor extends Phaser.Scene {
  ...
  create() {
    ...
    var roadCost = gameStats.rT * gameStats.roadMaintenance;
    var roadCostTotalText = this.add.bitmapText(525, 525, 'topaz', 'Total: $' + roadCost.toFixed(2), 40).setOrigin(0, .5).setTint(0xbf5846).setAlpha(1);
    ...
    var powerCost = (gameStats.powerCapacity * gameStats.powerMaintenance) * powerPercent

    var powerText = this.add.bitmapText(100, 650, 'topaz', 'P: ' + powerDraw + '/' + gameStats.powerCapacity + ' $' + powerCost.toFixed(2), 40).setOrigin(0, .5).setTint(0xbf5846).setAlpha(1);
    ...
    var policeText = this.add.bitmapText(100, 775, 'topaz', 'P: ' + policeNeed + '/' + gameStats.policeCapacity + ' $' + policeCost.toFixed(2), 40).setOrigin(0, .5).setTint(0xbf5846).setAlpha(1);
    ...
    var fireCost = (gameStats.fireCapacity * gameStats.fireMaintenance) * firePercent
    var fireText = this.add.bitmapText(785, 775, 'topaz', 'F: ' + fireNeed + '/' + gameStats.fireCapacity + ' $' + fireCost.toFixed(2), 40).setOrigin(1, .5).setTint(0xbf5846).setAlpha(1);
    ...
    var educationText = this.add.bitmapText(785, 900, 'topaz', 'E: ' + (Math.floor(censusHistory.resPopulation * .195)) + '/' + gameStats.educationCapacity + ' $' + educationCost.toFixed(2), 40).setOrigin(1, .5).setTint(0xbf5846).setAlpha(1);
    ...
    var govText = this.add.bitmapText(100, 1025, 'topaz', 'G: ' + gameStats.govBuildings + ' $' + govCost.toFixed(2), 40).setOrigin(0, .5).setTint(0xbf5846).setAlpha(1);
